...
int main(int argc, char **argv)
{
    ...
    double fop_time = 0.0;
    double acc_time = 0.0;
    double get_a_time = 0.0;
    double get_b_time = 0.0;
    double get_time = 0.0;
    ...
    get_time = get_a_time + get_b_time;

    double avg_fop_time = 0.0;
    double avg_acc_time = 0.0;
    double avg_get_a_time = 0.0;
    double avg_get_b_time = 0.0;
    double avg_get_time = 0.0;
    double avg_dgemm_time = 0.0;

    double min_fop_time = 0.0;
    double min_acc_time = 0.0;
    double min_get_a_time = 0.0;
    double min_get_b_time = 0.0;
    double min_get_time = 0.0;
    double min_dgemm_time = 0.0;

    double max_fop_time = 0.0;
    double max_acc_time = 0.0;
    double max_get_a_time = 0.0;
    double max_get_b_time = 0.0;
    double max_get_time = 0.0;
    double max_dgemm_time = 0.0;

    MPI_Reduce(&fop_time, &avg_fop_time, 1, MPI_DOUBLE, MPI_SUM, 0, MPI_COMM_WORLD);
    MPI_Reduce(&acc_time, &avg_acc_time, 1, MPI_DOUBLE, MPI_SUM, 0, MPI_COMM_WORLD);
    MPI_Reduce(&get_a_time, &avg_get_a_time, 1, MPI_DOUBLE, MPI_SUM, 0, MPI_COMM_WORLD);
    MPI_Reduce(&get_b_time, &avg_get_b_time, 1, MPI_DOUBLE, MPI_SUM, 0, MPI_COMM_WORLD);
    MPI_Reduce(&get_time, &avg_get_time, 1, MPI_DOUBLE, MPI_SUM, 0, MPI_COMM_WORLD);
    MPI_Reduce(&dgemm_time, &avg_dgemm_time, 1, MPI_DOUBLE, MPI_SUM, 0, MPI_COMM_WORLD);

    avg_fop_time /= nprocs;
    avg_acc_time /= nprocs;
    avg_get_a_time /= nprocs;
    avg_get_b_time /= nprocs;
    avg_get_time /= nprocs;
    avg_dgemm_time /= nprocs;

    MPI_Reduce(&fop_time, &min_fop_time, 1, MPI_DOUBLE, MPI_MIN, 0, MPI_COMM_WORLD);
    MPI_Reduce(&acc_time, &min_acc_time, 1, MPI_DOUBLE, MPI_MIN, 0, MPI_COMM_WORLD);
    MPI_Reduce(&get_a_time, &min_get_a_time, 1, MPI_DOUBLE, MPI_MIN, 0, MPI_COMM_WORLD);
    MPI_Reduce(&get_b_time, &min_get_b_time, 1, MPI_DOUBLE, MPI_MIN, 0, MPI_COMM_WORLD);
    MPI_Reduce(&get_time, &min_get_time, 1, MPI_DOUBLE, MPI_MIN, 0, MPI_COMM_WORLD);
    MPI_Reduce(&dgemm_time, &min_dgemm_time, 1, MPI_DOUBLE, MPI_MIN, 0, MPI_COMM_WORLD);

    MPI_Reduce(&fop_time, &max_fop_time, 1, MPI_DOUBLE, MPI_MAX, 0, MPI_COMM_WORLD);
    MPI_Reduce(&acc_time, &max_acc_time, 1, MPI_DOUBLE, MPI_MAX, 0, MPI_COMM_WORLD);
    MPI_Reduce(&get_a_time, &max_get_a_time, 1, MPI_DOUBLE, MPI_MAX, 0, MPI_COMM_WORLD);
    MPI_Reduce(&get_b_time, &max_get_b_time, 1, MPI_DOUBLE, MPI_MAX, 0, MPI_COMM_WORLD);
    MPI_Reduce(&get_time, &max_get_time, 1, MPI_DOUBLE, MPI_MAX, 0, MPI_COMM_WORLD);
    MPI_Reduce(&dgemm_time, &max_dgemm_time, 1, MPI_DOUBLE, MPI_MAX, 0, MPI_COMM_WORLD);

    if(rank == 0){
        printf("proc %d avg - fop %.3lf, acc %.3lf, get_a %.3lf, get_b %.3lf, get %.3lf, dgemm %.3lf\n", nprocs, avg_fop_time, avg_acc_time, avg_get_a_time, avg_get_b_time, avg_get_time, avg_dgemm_time);
        ...
        printf("proc %d max - fop %.3lf, acc %.3lf, get_a %.3lf, get_b %.3lf, get %.3lf, dgemm %.3lf\n", nprocs, max_fop_time, max_acc_time, max_get_a_time, max_get_b_time, max_get_time, max_dgemm_time);
        fflush(stdout);
    }
    ...
    MPI_Gather(&t_per_get_flush, 1, MPI_DOUBLE, t_get_flush_procs, 1, MPI_DOUBLE, 0, MPI_COMM_WORLD);
    MPI_Gather(&t_per_accum, 1, MPI_DOUBLE, t_accum_procs, 1, MPI_DOUBLE, 0, MPI_COMM_WORLD);
    MPI_Gather(&t_per_accum_flush, 1, MPI_DOUBLE, t_accum_flush_procs, 1, MPI_DOUBLE, 0, MPI_COMM_WORLD);
    ...
    MPI_Gather(&my_work_counter, 1, MPI_INT, all_worker_counter, 1, MPI_INT, 0, MPI_COMM_WORLD);
